<div class="card">
    <div class="card-header">
        <span><?= count($ressources) ?> ressource(s)</span>
        <a href="<?= base_url('admin/ressources/new') ?>" class="btn btn-primary btn-sm">+ Nouvelle ressource</a>
    </div>
    <table>
        <thead>
            <tr><th>Titre</th><th>Type</th><th>Accès</th><th>Prix</th><th>Actions</th></tr>
        </thead>
        <tbody>
        ...
        <?php if (empty($ressources)): ?>
            <tr><td colspan="5" style="text-align:center;color:#999;padding:2rem">Aucune ressource</td></tr>
        <?php endif; ?>
        </tbody>
    </table>
</div>
