...
<div class="modal-overlay" id="downloadModal" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="downloadModalTitle">
  <div class="modal-box">
    ...
    <p id="downloadModalDesc">Entrez votre email pour recevoir la ressource.</p>
    <form id="downloadForm">
      ...
      <button type="submit" class="btn-primary" style="width:100%;justify-content:center">Recevoir le lien →</button>
      <p style="font-size:12px;color:var(--gris);margin-top:10px;text-align:center">Pas de spam. Désabonnement en un clic.</p>
    </form>
  </div>
</div>
